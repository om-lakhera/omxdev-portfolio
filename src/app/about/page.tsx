...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "omlakhera204@gmail.com",
    href: "mailto:omlakhera204@gmail.com",
  ...
  {
    name: "GitHub",
    href: "https://github.com/om-lakhera",
    content: "/omxdev-portfolio",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Om Lakhera</p>
                <div className="text-xs bg-zinc-700 w-fit px-3 py-1 rounded-full">
                  Software Engineer • Web & Creative Development
                </div>
              </div>
            </div>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              I’m a software engineer interested in building clean, modern, and
              practical web experiences. I focus on writing simple, readable
              code and improving UI/UX through iteration. Currently exploring
              frontend, tooling, and creative development.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me playing games,
